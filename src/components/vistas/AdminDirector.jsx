...
const AdminDirector = () => {
  ...
  // ==========================================
  // LÓGICA DE RESPALDOS (BACKUP & RESTORE)
  // ==========================================
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-4">
                ...
                <div className="space-y-2">
                  <button className="w-full bg-slate-800 hover:bg-slate-900 cursor-pointer text-white font-bold py-3 px-4 rounded-lg text-sm transition-all flex items-center justify-center gap-2">
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                <div>
                  ...
                  <select className="w-full p-2.5 mt-1 text-sm border border-slate-200 rounded-lg cursor-pointer bg-white">
                ...
                <div>
                  ...
                  <input type="time" defaultValue="02:00" className="w-full p-2 mt-1 text-sm border border-slate-200 rounded-lg cursor-pointer" />
                </div>
                <button 
                  onClick={() => alert("✅ Configuración de respaldo automático guardada.")}
                  className="bg-emerald-600 hover:bg-emerald-700 cursor-pointer text-white font-bold h-[42px] rounded-lg text-sm transition-all"
                >
